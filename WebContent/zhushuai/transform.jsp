			...
			<div class="span3">
				<div class="well" style="padding: 8px 0;">
					<ul class="nav nav-list">
						...
						<li class="active"><a href="transform.jsp"><i class="icon-check"></i>转账</a></li>
				...
				<div class="span9">
					...
					<a class="toggle-link" href="#new-project"><i class="icon-plus"></i>转账</a>
					<form id="new-project" class="form-horizontal hidden" action="transform">
						<fieldset>
							<legend></legend>
							<div class="control-group">
								<label class="control-label" for="input01">转出账号</label>
								<div class="controls">
									<input type="text" class="input-xlarge" id="input01" name="toId"/>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" class="input-xlarge" id="input01" name="pwd"/>
								</div>
							</div>
							<div class="form-actions">
								<button type="submit" class="btn btn-primary">提交</button> <button class="btn" type="reset">取消</button>
							</div>
						</fieldset>
					</form>
				</div>
